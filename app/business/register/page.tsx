  ...
  return (
    <div className="min-h-[calc(100vh-16rem)] flex items-center justify-center px-4 py-16 relative overflow-hidden">
      ...
      <div className="container mx-auto max-w-lg">
        ...
        >
          <h1 className="text-4xl font-bold text-dark-900 dark:text-white mb-2">Join EasyDrop</h1>
          <p className="text-dark-600 dark:text-light-400">Create your business account to get started</p>
        </motion.div>
